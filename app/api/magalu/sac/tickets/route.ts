/**
 * GET /api/magalu/sac/tickets
 * Lista tickets de SAC do Magalu.
 * Tenta /seller/v1/tickets — se 403/404, retorna fallback vazio.
 */
...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    console.warn('[Magalu SAC] tickets endpoint error:', err)
    return NextResponse.json({ items: [], total: 0, available: false, message: 'SAC endpoint não disponível neste escopo' })
  }
}
