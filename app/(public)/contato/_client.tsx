...
export default function ContatoPage() {
  ...
  return (
    <div className="bg-[#0A0718] stars-bg min-h-screen overflow-x-hidden">
      ...
      <nav className="sticky top-0 z-50 bg-[#0A0718]/80 backdrop-blur-xl border-b border-white/5">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-7 text-sm font-medium text-slate-400">
            ...
            <Link href="/integracoes" className="hover:text-violet-300 transition-colors">Integrações</Link>
            <Link href="/contato" className="text-violet-400 font-semibold transition-colors">Contato</Link>
          </div>
      ...
      {/* Hero */}
      <section className="relative z-10 pt-20 pb-10 px-6 text-center border-b border-white/5">
        <div className="max-w-3xl mx-auto">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white leading-tight mb-3" style={{ fontFamily: 'Sora, sans-serif' }}>
            Entre em contato
          </h1>
          <p className="text-lg text-slate-400">Estamos aqui para ajudar</p>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          <div className="md:col-span-2 space-y-5">
            <div className="glass-card p-6 space-y-5">
              <h2 className="text-sm font-bold text-slate-500 uppercase tracking-wider">Informações de contato</h2>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-xs font-semibold text-slate-500 uppercase tracking-wide mb-0.5">E-mail</p>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-xs font-semibold text-slate-500 uppercase tracking-wide mb-0.5">Localização</p>
                  <p className="text-sm font-semibold text-slate-100">Fortaleza — CE — Brasil</p>
                </div>
              </div>
            </div>

            {/* API evaluators note */}
            <div className="glass-card p-6 border-l-4 border-purple-500/60">
              <p className="text-xs font-bold text-violet-400 uppercase tracking-wider mb-2">For API Evaluators</p>
          ...
          <div className="md:col-span-3">
            <div className="glass-card p-8">
              <h2 className="text-base font-bold text-white mb-6" style={{ fontFamily: 'Sora, sans-serif' }}>
                Envie uma mensagem
              </h2>
              ...
              <div className="space-y-5">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2.5 rounded-xl border border-white/10 text-sm text-slate-100 placeholder-slate-600 bg-white/5 focus:outline-none focus:ring-2 focus:ring-violet-500/40 focus:border-violet-500/60 transition-all"
                    />
                  </div>
                  <div>
                    <label className="block text-xs font-semibold text-slate-500 uppercase tracking-wide mb-1.5">
                ...
                <div>
                  ...
                  <select
                    ...
                    value={form.assunto}
                    onChange={handleChange}
                    className="w-full px-4 py-2.5 rounded-xl border border-white/10 text-sm text-slate-100 bg-white/5 focus:outline-none focus:ring-2 focus:ring-violet-500/40 focus:border-violet-500/60 transition-all"
                  >
                    <option value="" className="bg-[#0A0718] text-slate-400">Selecione um assunto</option>
                    <option value="suporte" className="bg-[#0A0718] text-slate-100">Suporte técnico</option>
                    <option value="comercial" className="bg-[#0A0718] text-slate-100">Comercial / Planos</option>
                    <option value="parceria" className="bg-[#0A0718] text-slate-100">Parceria / Integrações</option>
                    <option value="privacidade" className="bg-[#0A0718] text-slate-100">Privacidade de dados</option>
                    <option value="outro" className="bg-[#0A0718] text-slate-100">Outro</option>
                  </select>
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={5}
                    className="w-full px-4 py-2.5 rounded-xl border border-white/10 text-sm text-slate-100 placeholder-slate-600 bg-white/5 focus:outline-none focus:ring-2 focus:ring-violet-500/40 focus:border-violet-500/60 transition-all resize-none"
                  />
                </div>

                <button
                  type="button"
                  className="bg-violet-600 hover:bg-violet-500 text-white w-full py-3 rounded-xl text-sm font-semibold transition-colors"
                  onClick={() => {
