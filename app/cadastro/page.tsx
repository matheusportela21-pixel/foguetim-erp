        ...
        <div className="min-h-full flex flex-col items-center justify-center px-6 py-10">
          ...
          <div className="w-full max-w-md">
            ...
            <button
              type="button"
              disabled
              className="w-full flex items-center justify-center gap-3 py-2.5 rounded-xl border border-white/[0.07] bg-white/[0.03] text-slate-500 text-sm font-medium cursor-not-allowed mb-5 relative"
            >
              ...
              <span className="absolute right-3 text-[10px] font-semibold px-1.5 py-0.5 rounded-full bg-amber-500/15 text-amber-400">
                Em breve
              </span>
            </button>
